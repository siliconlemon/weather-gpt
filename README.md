...
The UI uses self-hosted fonts (`static/css/fonts.css`, `static/fonts/`), **Lucide** (`static/vendor/lucide.min.js`), and plain `static/js/app.js` — **no Node** is required to run or develop the frontend unless you want to regenerate those vendored assets.
...
- `templates/`, `static/` — UI, i18n JSON (`static/i18n/cs.json`, `en.json`), `static/css/app.css`, vendored fonts and Lucide
- `tests/` — pytest suite
